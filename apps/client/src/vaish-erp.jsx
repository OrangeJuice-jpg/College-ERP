...
export default function App() {
  ...
  const SidebarContent = () => (
    <>
      <div style={{ padding: "26px 22px 20px", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
        ...
        {isMobile && (
          <button onClick={() => setSidebarOpen(false)} style={{ background: "none", border: "none", color: T.muted, fontSize: 22, cursor: "pointer", padding: 4 }}>✕</button>
        )}
      </div>
      ...
      <div style={{ padding: "16px 22px", borderTop: `1px solid ${T.border}`, marginTop: 8 }}>
        <div style={{ fontSize: 10, color: T.faint, lineHeight: 1.6 }}>
          {userEmail}<br />Academic Year 2024–25
        </div>
      </div>
    </>
  );
    ...
    <>
      ...
      <div style={{ display: "flex", minHeight: "100vh", background: T.bg }}>
        ...
        {isMobile && sidebarOpen && (
          <>
            <div onClick={() => setSidebarOpen(false)} style={{
              position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 99,
            }} />
            <aside style={{
        ...
        <main style={{
          ...
          flex: 1,
          padding: isMobile ? "16px 14px 84px" : "32px 32px",
          minWidth: 0,
          minHeight: "100vh",
        }}>
          {/* Top bar */}
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: isMobile ? 18 : 30 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                <div style={{ fontSize: isMobile ? 18 : 24, fontWeight: 800, color: T.text, fontFamily: "'Syne', sans-serif", letterSpacing: -0.5 }}>{activeTab}</div>
                {!isMobile && (
